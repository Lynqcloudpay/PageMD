  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed bottom-4 right-4 z-50 w-14 h-14 rounded-full bg-primary-600 hover:bg-primary-700 text-white shadow-lg flex items-center justify-center"
        style={{ 
