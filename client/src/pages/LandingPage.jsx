        ...
        <div className="min-h-screen bg-white font-sans overflow-x-hidden">
            ...
            <section className="relative pt-24 pb-16 lg:pt-36 lg:pb-28 bg-white overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-[0.95] mb-6 tracking-tight">
                    ...
                    <div className="mt-14 flex flex-col items-center">
                        ...
                        <p className="text-gray-400 text-[10px] font-bold uppercase tracking-[0.3em]">Trusted by Physicians Nationwide</p>
                    </div>
                </div>
            </section>

            {/* Problem/Solution Section */}
            <section className="py-16 lg:py-24 bg-gray-50 border-y border-gray-200/60 px-6">
                <div className="max-w-6xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight">The Modern EMR Is Broken. <br /><span className="text-blue-600">We Fixed It.</span></h2>
                            ...
                            <div className="relative space-y-5">
                                <div className="p-6 bg-white rounded-2xl border border-gray-200 shadow-lg">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Legacy Systems</span>
                                    </div>
                                    <h4 className="text-base font-medium text-gray-900 mb-2 italic">"Too many menus, slow loading, and constant friction."</h4>
            ...
            <section className="py-20 bg-white px-6">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-14">
                        ...
                        <p className="text-base text-gray-500 max-w-xl mx-auto">A complete practice management solution that actually feels like modern software.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={i} className="group flex flex-col items-center text-center p-6 rounded-2xl transition-all hover:bg-gray-50 border border-transparent hover:border-gray-100">
            ...
            {/* CTA */}
            <section className="py-40 bg-gray-50 px-6 border-t border-gray-200/50">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-5xl md:text-[6rem] font-bold text-gray-900 mb-12 leading-[1] tracking-tighter">Ready to reclaim your day?</h2>
                    ...
                    <div className="mt-24 flex justify-center items-center gap-12 opacity-40">
                        <div className="flex items-center gap-3 text-gray-900 text-xs font-bold uppercase tracking-widest">
            ...
            <footer className="py-16 px-6 bg-white border-t border-gray-100">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 text-gray-400">
