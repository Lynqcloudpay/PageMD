        ...
        <div className="h-full bg-white w-full">
            <div className="p-4 w-full">
                ...
                <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-200">
                    <div>
                        <h1 className="text-xl font-bold text-[#111827] mb-0.5 uppercase tracking-tight">Patients</h1>
                ...
                <div className="mb-6 bg-blue-50/50 p-4 rounded-xl border border-blue-100 shadow-sm" onKeyDown={handleKeyDown}>
                    ...
                    <div className="flex justify-end gap-2 mt-3">
                        ...
                        <button
                            ...
                            className="px-4 py-1.5 bg-[#2563EB]/10 text-[#2563EB] hover:bg-[#2563EB]/15 text-xs font-medium rounded-lg transition-all border border-[#2563EB]/20"
                        >
                            Search (Enter)
                        </button>
                    </div>
                        ...
                        {loading ? (
                            ...
                            <div className="p-12 text-center text-gray-500">
                                ...
                                <div className="space-y-4 max-w-xs mx-auto text-left bg-gray-50 p-4 rounded-lg border border-gray-100">
                                    <p className="text-xs font-medium text-[#111827]/40 uppercase tracking-widest">Suggestions:</p>
...
const PatientListItem = ({ patient, index, onClick, highlight }) => (
    ...
    >
        <div className="flex items-center gap-3 flex-1 min-w-0">
            <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-[#2563EB]/10 flex items-center justify-center text-sm font-medium text-[#2563EB] group-hover:bg-[#2563EB]/15 transition-all">
                {index + 1}
            </div>
