  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-full min-h-[400px] gap-3">
        ...
        <p className="text-xs font-medium text-gray-400 uppercase tracking-widest animate-pulse">Loading Systems...</p>
      </div>
    );
  }

  return (
    <div className="flex flex-col h-full -mx-6 -mb-6 bg-gray-50/30">
      {/* Clinic Style Standard Header */}
      <div className="bg-white border-b border-gray-100 px-6 py-4 flex-shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-2xl bg-gray-50 flex items-center justify-center shadow-sm border border-gray-100">
              <Settings className="w-5 h-5 text-blue-600" />
            </div>
            <div>
              <h1 className="text-xl font-bold text-[#111827] tracking-tighter uppercase mb-0.5">Administration & Settings</h1>
              <div className="flex items-center gap-2 mt-0.5">
                <span className="text-[10px] font-medium text-gray-500 uppercase tracking-widest leading-none">Practice Control Panel</span>
                <span className="w-1 h-1 rounded-full bg-gray-100"></span>
                <span className="text-[10px] font-medium text-gray-400">Manage clinical configuration, users, and security</span>
              </div>
            </div>
          </div>
      ...
      <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-gray-100 overflow-x-auto scroller-hidden">
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-sm font-semibold text-gray-800 uppercase tracking-widest leading-none">Practice Information</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          <div className="md:col-span-2">
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">Practice Name *</label>
            <input
              type="text"
              value={settings.practice_name || ''}
              onChange={(e) => updateField('practice_name', e.target.value)}
              className="w-full px-4 py-2 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 text-sm transition-all"
              placeholder="My Practice"
            />
          </div>

          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">Practice Type</label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">Tax ID</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">NPI</label>
              <input
                type="text"
                maxLength={10}
                value={settings.npi || ''}
          ...
          <div className="md:col-span-2">
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">Clinic Address</label>
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <input
                  ...
                  placeholder="State"
                  className="w-full px-4 py-2 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 text-sm transition-all text-center"
                />
                <input
                  type="text"
                  value={settings.zip || ''}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">Phone</label>
              <input
                type="tel"
            ...
            <div>
              <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">Fax</label>
              <input
                type="tel"
                value={settings.fax || ''}
          ...
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">Official Email</label>
            <input
              type="email"
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-sm font-semibold text-gray-800 uppercase tracking-widest leading-none">Practice Branding</h2>
        </div>

        <div className="flex flex-col md:flex-row items-center md:items-start gap-12">
          <div className="shrink-0">
            <div className="relative group">
              <div className="w-48 h-48 border border-gray-100 rounded-[2.5rem] flex items-center justify-center overflow-hidden bg-gray-50/50 group-hover:border-indigo-200 transition-all duration-300 shadow-inner">
                {settings.logo_url ? (
                ...
                <div className="absolute inset-0 bg-indigo-600/10 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-all duration-300">
                  <button
                    ...
                    className="w-12 h-12 bg-white rounded-2xl text-indigo-600 shadow-xl flex items-center justify-center transform scale-75 group-hover:scale-100 transition-all duration-300 hover:bg-gray-50 active:scale-90"
          ...
          <div className="flex-1 space-y-6 py-4">
            <div>
              <h4 className="text-[11px] font-medium text-gray-800 uppercase tracking-widest mb-3">Logo Guidelines</h4>
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <div key={idx} className="flex items-center gap-2 px-4 py-2 bg-gray-50/80 rounded-xl border border-gray-100">
                  <item.icon className="w-3 h-3 text-emerald-500" />
                  <span className="text-[10px] font-medium text-gray-600 uppercase tracking-wider">{item.label}</span>
                </div>
              ))}
            </div>
            ...
            <div className="pt-4 divide-y divide-gray-100">
              <div className="py-4">
                <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">Practice Website</label>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                    <Globe className="w-4 h-4 text-gray-400 group-focus-within:text-indigo-400 transition-colors" />
                  </div>
                  <input
                    type="url"
                    value={settings.website || ''}
                    onChange={(e) => updateField('website', e.target.value)}
                    className="w-full pl-12 pr-4 py-2 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 text-sm transition-all"
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-sm font-semibold text-gray-800 uppercase tracking-widest leading-none">Regional & Systems</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">Timezone</label>
            <select
              value={settings.timezone || 'America/New_York'}
              onChange={(e) => updateField('timezone', e.target.value)}
              className="w-full px-4 py-2.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 text-sm appearance-none cursor-pointer transition-all"
            >
          ...
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">Date Format</label>
            <select
          ...
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">Time Format</label>
            <select
          ...
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">Scheduling Start Time</label>
            <input
              type="time"
          ...
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-2 px-1">Scheduling End Time</label>
            <input
              type="time"
      ...
      <div className="sticky bottom-0 z-20 py-6 pr-6 pointer-events-none flex justify-end translate-y-2">
        <button
          onClick={onSave}
          disabled={saving}
          className="pointer-events-auto group px-8 py-3.5 bg-[#2563EB] text-white rounded-2xl font-semibold text-xs uppercase tracking-widest flex items-center gap-3 shadow-[0_2px_8px_rgba(131,162,219,0.2)] hover:bg-[#2563EB]/90 active:scale-95 transition-all disabled:opacity-50 disabled:scale-100"
        >
          {saving ? (
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-sm font-semibold text-gray-800 uppercase tracking-widest leading-none">Password Policy</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
          <div className="space-y-6">
            <div>
              <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">Min Length Requirement</label>
              <input
                type="number"
                min={6}
                max={32}
                ...
                className="w-full px-4 py-2.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 text-sm transition-all"
              />
            </div>

            <div className="p-4 bg-gray-50/50 rounded-2xl border border-gray-100 space-y-3">
              <p className="text-[10px] font-medium text-gray-400 uppercase tracking-widest mb-2">Complexity Rules</p>
              {[
                ...
                <label key={check.id} className="flex items-center justify-between group cursor-pointer">
                  <span className="text-sm text-gray-600 group-hover:text-gray-900 transition-colors">{check.label}</span>
                  <div
                    onClick={(e) => { e.preventDefault(); toggleField(check.id); }}
                    className={cn(
                      "w-10 h-6 rounded-full relative transition-all duration-300",
                      settings[check.id] ?? true ? "bg-indigo-600 shadow-lg shadow-indigo-100" : "bg-gray-100"
                    )}
                  >
                    <div className={cn(
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">Audit Trail Retention</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                  <Clock className="w-4 h-4 text-gray-400 group-focus-within:text-indigo-400 transition-colors" />
                </div>
                <input
                  type="number"
                  min={30}
                  ...
                  className="w-full pl-12 pr-4 py-2.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 text-sm transition-all"
                />
              </div>
              <p className="text-[10px] text-gray-400 px-1 mt-2 font-medium">Industry standard is 365 days or greater.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-sm font-semibold text-gray-800 uppercase tracking-widest leading-none">Access Control</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">Session Timeout</label>
            <div className="flex items-center gap-3">
              <input
                ...
                className="flex-1 px-4 py-2.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 text-sm transition-all text-center"
              />
              <span className="text-[10px] font-medium text-gray-400 uppercase">Min</span>
            </div>
          </div>
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">Inactivity Lock</label>
            <div className="flex items-center gap-3">
              <input
                type="number"
                min={5}
          ...
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">Max Login Fails</label>
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 px-4 py-2.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 text-sm transition-all text-center font-medium text-rose-600"
              />
              <span className="text-[10px] font-medium text-gray-400 uppercase">Attempts</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-slate-50 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-6 bg-indigo-50/50 rounded-3xl border border-indigo-100/30">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-sm font-medium text-gray-800">Multi-Factor Authentication (MFA)</h3>
            </div>
                ...
                <label key={check.id} className="flex items-center gap-3 cursor-pointer group">
                  <div
                    ...
                    className={cn(
                      ...
                      settings[check.id] ? "bg-indigo-600 border-indigo-600" : "bg-white border-gray-200 group-hover:border-indigo-300"
                    )}
                  >
                    {settings[check.id] && <CheckCircle2 className="w-3 h-3 text-white" />}
                  </div>
                  <span className="text-sm text-gray-600 font-medium group-hover:text-gray-900 transition-colors">{check.label}</span>
                </label>
              ))}
            </div>
          </div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-sm font-semibold text-gray-800 uppercase tracking-widest leading-none">Visit Requirements</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-4">
            <p className="text-[10px] font-medium text-gray-400 uppercase tracking-widest mb-4">Mandatory Documentation</p>
            {[
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">Default Visit Duration</label>
              <div className="flex items-center gap-3">
                <input
                  type="number"
                  min={5}
                  ...
                  className="w-24 px-4 py-2.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 text-sm transition-all text-center"
                />
                <span className="text-[10px] font-medium text-gray-400 uppercase">Minutes</span>
              </div>
            </div>

            <div>
              <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">Scheduling Density</label>
              <div className="flex items-center gap-3">
                <input
                  type="number"
                  min={1}
                  ...
                  className="w-24 px-4 py-2.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 text-sm transition-all text-center disabled:bg-gray-50 disabled:text-gray-400"
                  placeholder="∞"
                />
                <button
                  type="button"
                  ...
                  className={cn(
                    ...
                    !settings.max_appointments_per_slot ? "bg-indigo-50 border-indigo-100 text-indigo-600" : "bg-white border-gray-200 text-gray-500 hover:bg-gray-50"
                  )}
                >
                  {!settings.max_appointments_per_slot ? 'Set Cap' : 'Unlock Slot'}
                </button>
              </div>
              <p className="text-[10px] text-gray-400 px-1 mt-2 font-medium">
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-sm font-semibold text-gray-800 uppercase tracking-widest leading-none">Clinical Decision Support</h2>
        </div>
        ...
        <div className="space-y-4 max-w-lg">
          {[
            ...
            <label key={check.id} className="flex items-center justify-between group p-4 rounded-2xl bg-gray-50/50 border border-gray-100 cursor-pointer hover:bg-indigo-50/30 transition-all">
              <span className="text-sm font-medium text-gray-600 group-hover:text-gray-900 transition-colors">{check.label}</span>
              <div
                onClick={(e) => { e.preventDefault(); toggleField(check.id); }}
                className={cn(
                  "w-10 h-6 rounded-full relative transition-all duration-300",
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-sm font-semibold text-gray-800 uppercase tracking-widest leading-none">Data Retention Policy</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={field.id}>
              <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">{field.label}</label>
              <div className="flex items-center gap-3">
                <input
                  type="number"
                  min={365}
                  ...
                  className="w-full px-4 py-2.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 text-sm transition-all text-center"
                />
                <span className="text-[10px] font-medium text-gray-400 uppercase tracking-tighter">Days</span>
              </div>
            </div>
          ))}
        </div>
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-sm font-medium text-gray-800 uppercase tracking-widest leading-none">Email Notifications</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">From Name</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">From Email</label>
            <input
              type="email"
          ...
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">Reply-To Address</label>
            <input
              type="email"
          ...
          <div>
            <label className="block text-[10px] font-medium text-gray-500 uppercase tracking-widest mb-3 px-1">Sandbox Test Address</label>
            <input
              type="email"
              value={settings.test_email || ''}
              onChange={(e) => updateField('test_email', e.target.value)}
              className="w-full px-4 py-2.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 text-sm transition-all italic"
        ...
        <div className="mt-8 pt-6 border-t border-slate-50">
          <label className="flex items-center gap-3 cursor-pointer group w-fit">
            <div
              ...
              className={cn(
                "w-5 h-5 rounded-lg border-2 flex items-center justify-center transition-all duration-200",
                settings.enabled ? "bg-indigo-600 border-indigo-600" : "bg-white border-gray-200 group-hover:border-indigo-300"
              )}
            >
              {settings.enabled && <CheckCircle2 className="w-3 h-3 text-white" />}
            </div>
            <span className="text-sm text-gray-600 font-medium group-hover:text-gray-900 transition-colors">Enable automatic email transmissions</span>
          </label>
        </div>
      </div>
    ...
    <div className="space-y-8">
      <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-sm font-medium text-gray-800 uppercase tracking-widest leading-none">Feature Control Matrix</h2>
        </div>
        ...
        <div className="mt-8 space-y-10">
          {Object.keys(groupedFeatures).map(category => (
            <div key={category} className="space-y-4">
              <div className="flex items-center gap-4">
                <h3 className="text-[10px] font-medium text-gray-400 uppercase tracking-[0.2em] whitespace-nowrap">{categoryLabels[category] || category}</h3>
                <div className="h-px bg-gray-50 w-full"></div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {groupedFeatures[category].map(feature => (
                  <div key={feature.id} className="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl border border-gray-100 hover:bg-white hover:shadow-sm transition-all group">
                    <div className="flex-1 pr-4">
                      <div className="text-sm font-medium text-gray-700 group-hover:text-indigo-900 transition-colors uppercase tracking-tight">{feature.description || feature.feature_key}</div>
                      {feature.requires_config && (
                        <div className="text-[10px] text-gray-400 font-medium mt-1 uppercase tracking-wide">Requires Configuration</div>
                      )}
                    </div>
                    <button
  ...
  return (
    <div className="space-y-5 max-w-4xl">
      ...
      <div className="bg-white border border-gray-100 rounded-xl p-5 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2.5">
            ...
            <h2 className="text-xs font-semibold text-gray-700 uppercase tracking-wider">Subscription</h2>
          </div>
          <div className={cn(
        ...
        <div className="flex items-end justify-between mb-4 pb-4 border-b border-slate-50">
          <div>
            <p className="text-[10px] text-gray-400 uppercase tracking-wider mb-0.5">Current Tier</p>
            <p className="text-lg font-semibold text-gray-800">{currentTierName}</p>
          </div>
          <div className="text-right">
            <p className="text-[10px] text-gray-400 uppercase tracking-wider mb-0.5">Monthly Total</p>
            <p className="text-lg font-semibold text-gray-800">${billing.monthlyTotal || 0}</p>
          </div>
        </div>

        {/* Billing Breakdown — Compact Stats */}
        <div className="grid grid-cols-5 gap-3 mb-4">
          <div className="bg-gray-50/80 rounded-lg p-2.5 text-center">
            <p className="text-sm font-semibold text-gray-700">{billing.physicalSeats || 0}</p>
            <p className="text-[9px] text-gray-400 uppercase tracking-wider mt-0.5">Physical</p>
          </div>
          <div className="bg-gray-50/80 rounded-lg p-2.5 text-center">
            <p className="text-sm font-semibold text-teal-600">{billing.ghostSeats || 0}</p>
            <p className="text-[9px] text-gray-400 uppercase tracking-wider mt-0.5">Ghost</p>
          </div>
          <div className="bg-gray-50/80 rounded-lg p-2.5 text-center">
            <p className="text-sm font-semibold text-gray-700">{billing.totalSeats || 0}</p>
            <p className="text-[9px] text-gray-400 uppercase tracking-wider mt-0.5">Total</p>
          </div>
          <div className="bg-gray-50/80 rounded-lg p-2.5 text-center">
            <p className="text-sm font-semibold text-gray-700">${billing.virtualTotal || 0}</p>
            <p className="text-[9px] text-gray-400 uppercase tracking-wider mt-0.5">Virtual</p>
          </div>
          <div className="bg-gray-50/80 rounded-lg p-2.5 text-center">
            <p className="text-sm font-semibold text-gray-700">${billing.effectiveRate || 0}</p>
            <p className="text-[9px] text-gray-400 uppercase tracking-wider mt-0.5">Per MD</p>
          </div>
        </div>

        {/* Equation Summary */}
        <div className="bg-blue-50/50 border border-blue-100/40 rounded-lg px-3.5 py-2.5 flex items-center justify-between text-xs text-gray-600 mb-4">
          <span>{billing.physicalSeats || 0} MDs × ${billing.effectiveRate || 0}/mo</span>
          <span className="font-semibold text-gray-800">${billing.monthlyTotal || 0}/mo</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          {hasSubscription ? (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gray-100 text-white rounded-lg text-xs font-medium hover:bg-gray-100 transition-colors disabled:opacity-50"
            >
          ...
          {hasSubscription && (
            <button
              onClick={openPortal}
              disabled={redirecting}
              className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-lg text-xs font-medium hover:bg-gray-50 transition-colors disabled:opacity-50"
            >
        ...
        invoices.length > 0 && (
          <div className="bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden">
            <div className="px-4 py-3 border-b border-slate-50 flex items-center gap-2">
              ...
              <h3 className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider">Payment History</h3>
            </div>
            <table className="w-full text-xs">
              <thead>
                <tr className="text-[10px] text-gray-400 uppercase tracking-wider border-b border-slate-50">
              ...
              <tbody className="divide-y divide-gray-50">
                {invoices.map((inv) => (
                  <tr key={inv.id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-4 py-2.5 text-gray-600 font-medium">{inv.description}</td>
                    <td className="px-4 py-2.5 text-right font-mono text-gray-700">${inv.amountDollars}</td>
      ...
      <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
        <h3 className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider mb-3">Volume Pricing Tiers</h3>
          ...
          {ALL_TIERS.map((tier) => (
            ...
            >
              <p className={cn(
                ...
                currentTierName === tier.name ? "text-blue-600" : "text-gray-500"
              )}>
                {tier.name}
              </p>
              <p className="text-sm font-semibold text-gray-800">${tier.rate}</p>
              <p className="text-[9px] text-gray-400 mt-0.5">{tier.range} MDs</p>
              {currentTierName === tier.name && (
      ...
      <div className="bg-gray-50/50 border border-gray-100 rounded-xl p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider">Grace Period & Termination Policy</h3>
        </div>
        <div className="grid grid-cols-2 gap-8">
          <div className="space-y-4">
            <div>
              <p className="text-xs font-semibold text-gray-700 mb-1.5">1. Duning Cycle (45 Days)</p>
              <ul className="text-[11px] text-gray-500 space-y-2 leading-relaxed">
                <li><span className="text-gray-700 font-medium">Days 1-15 (Warning):</span> Full system access but banners are shown. Stripe smart-retries active.</li>
                <li><span className="text-gray-700 font-medium">Days 16-30 (Degraded):</span> Read-Only mode. View/Export charts only.</li>
                <li><span className="text-gray-700 font-medium">Days 31-45 (Locked):</span> Full lockout. HIPAA data retention active.</li>
              </ul>
            </div>
          </div>
          <div className="space-y-4">
            <div>
              <p className="text-xs font-semibold text-gray-700 mb-1.5">2. Termination & Data Retention</p>
            ...
            <div className="pt-2">
              <p className="text-[10px] text-gray-400 italic">Effective Jan 1, 2026. Standard across all tiers.</p>
            </div>
          </div>
        </div>
      </div>
