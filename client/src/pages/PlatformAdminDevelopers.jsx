...
const PlatformAdminDevelopers = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-[1600px] mx-auto px-6 py-8">
                ...
                <div className="mb-8">
                    ...
                    <div className="flex justify-between items-start">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-800 mb-2">Developer Platform</h1>
                            <p className="text-gray-500 font-medium">Manage API partners, secure credentials, and third-party integrations</p>
                        </div>
                        <button
                ...
                <div className="grid grid-cols-12 gap-8">
                    ...
                    <div className="col-span-3 space-y-4">
                        <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest px-2">Partners</h3>
                            ...
                            {partners.length === 0 ? (
                                ...
                                partners.map(partner => (
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-4 flex items-center gap-3 transition-all border-b border-gray-100 last:border-0 ${selectedPartner?.id === partner.id
                                    ...
                                    >
                                        ...
                                        <div className="min-w-0">
                                            <p className={`font-bold text-sm truncate ${selectedPartner?.id === partner.id ? 'text-blue-900' : 'text-gray-700'}`}>
                                                {partner.name}
                                            </p>
                                            <p className="text-[10px] text-gray-400 truncate">{partner.contact_email}</p>
                                        </div>
                                    </button>
                                ))
                            )}
                    ...
                    <div className="col-span-9 space-y-6">
                        {selectedPartner ? (
                                ...
                                <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-200">
                                    <div className="flex justify-between items-start mb-6">
                                        <div>
                                            ...
                                            <p className="text-gray-500 text-sm mt-1">{selectedPartner.description || 'No description provided'}</p>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-3 gap-6">
                                        ...
                                        <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                                            <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Partner Since</p>
                                        ...
                                        <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                                            ...
                                            <p className="text-sm font-bold text-gray-800 truncate">{selectedPartner.contact_email}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <button
                                            ...
                                            className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 text-white rounded-lg hover:bg-gray-50 transition-all text-xs font-bold"
                                        >
                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                        {apps.length === 0 ? (
                                            <div className="bg-white rounded-2xl p-12 text-center border-2 border-dashed border-gray-200">
                                                ...
                                                <h4 className="font-bold text-gray-500">No applications found</h4>
                                                <p className="text-sm text-gray-400">Create an application to generate API credentials</p>
                                            </div>
                                        ) : (
                                            apps.map(app => (
                                                <div key={app.id} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 flex items-center gap-6">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <p className="text-xs text-gray-400 font-mono">ID: {app.client_id}</p>
                                                    </div>

                                                    <div className="flex flex-wrap gap-2 w-48 justify-end">
                                                        {app.allowed_scopes?.slice(0, 2).map(s => (
                                                            <span key={s} className="px-1.5 py-0.5 bg-gray-50 text-gray-500 rounded text-[9px] font-medium border border-gray-200">
                                                                {s}
                                                            </span>
                                                        ))}
                                                        {app.allowed_scopes?.length > 2 && <span className="text-[9px] text-gray-400">+{app.allowed_scopes.length - 2} more</span>}
                                                    </div>
                            ...
                            <div className="bg-white rounded-3xl p-20 text-center border border-gray-200 shadow-sm flex flex-col items-center">
                                <div className="w-20 h-20 bg-gray-50 rounded-full flex items-center justify-center mb-6">
                                    <Server className="w-10 h-10 text-gray-300" />
                                </div>
                                <h2 className="text-2xl font-bold text-gray-800">Select a Partner</h2>
                                <p className="text-gray-500 mt-2 max-w-sm">Choose a partner from the sidebar to manage their API applications and credentials.</p>
                            </div>
                        )}
                    </div>
                </div>
            ...
            {isCreatingPartner && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
                    <div className="w-full max-w-md bg-white rounded-3xl p-8 shadow-2xl">
                        <h2 className="text-xl font-bold text-gray-800 mb-6">Create New Partner</h2>
                        <div className="space-y-4">
                            <div>
                                <label className="block text-xs font-bold text-gray-500 mb-1.5">Partner Name</label>
                                <input
                                    type="text"
                                    value={newPartner.name}
                                    onChange={e => setNewPartner({ ...newPartner, name: e.target.value })}
                                    className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:border-blue-500 outline-none transition-all"
                                    placeholder="e.g. DoseSpot Inc"
                                />
                            </div>
                            <div>
                                <label className="block text-xs font-bold text-gray-500 mb-1.5">Contact Email</label>
                                <input
                                    type="email"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:border-blue-500 outline-none transition-all h-24"
                                />
                            </div>
                        </div>
            ...
            {isCreatingApp && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
                    <div className="w-full max-w-xl bg-white rounded-3xl p-8 shadow-2xl">
                        <h2 className="text-xl font-bold text-gray-800 mb-6">Create Integration App</h2>
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="col-span-2">
                                    <label className="block text-xs font-bold text-gray-500 mb-1.5">App Name</label>
                                    <input
                                        type="text"
                                        value={newApp.name}
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-gray-500 mb-1.5">Environment</label>
                                    <select
                                        value={newApp.env}
                            ...
                            <div>
                                <label className="block text-xs font-bold text-gray-500 mb-3">Permissions (Scopes)</label>
                                <div className="grid grid-cols-2 gap-2">
                                    {scopes.map(s => (
                                        <label key={s.scope} className="flex items-center gap-2 p-2 rounded-lg border border-gray-100 hover:bg-gray-50 cursor-pointer">
                                            <input
                                                type="checkbox"
                                            ...
                                            />
                                            <div className="min-w-0">
                                                <p className="text-[10px] font-bold text-gray-700 truncate">{s.scope}</p>
                                                <p className="text-[9px] text-gray-400 truncate">{s.description}</p>
                                            </div>
                                        </label>
                                    ))}
                                </div>
            ...
            {showSecretModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-50/90 backdrop-blur-md">
                    <div className="w-full max-w-lg bg-white rounded-[2rem] p-10 text-center relative shadow-2xl">
                        ...
                        <h2 className="text-2xl font-bold text-gray-800">Save Your Secret</h2>
                        <p className="text-sm text-gray-500 mt-2 mb-8">
                            This secret will be shown **only once**. If you lose it, you will need to rotate it and update all systems.
                        </p>

                        <div className="bg-gray-50 border-2 border-gray-100 rounded-2xl p-6 flex items-center gap-4 mb-8">
                            ...
                            <button
                                ...
                                className="p-3 bg-white border border-gray-200 rounded-xl hover:bg-blue-50 hover:border-blue-200 transition-all text-blue-500"
                            >
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-gray-100 text-white rounded-2xl font-bold hover:bg-gray-50 transition-all shadow-xl shadow-slate-900/20"
                        >
