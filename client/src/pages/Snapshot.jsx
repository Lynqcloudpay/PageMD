                            ...
                            <div className="flex-shrink-0 ml-2 flex items-center gap-2">
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        if (id) {
                                            // If there's an open note from today, open it instead of creating new
                                            if (todaysOpenNote && todaysOpenNote.id) {
                                                const targetPath = `/patient/${id}/visit/${todaysOpenNote.id}`;
                                                console.log('Opening today\'s existing note:', targetPath);
                                                navigate(targetPath);
                                            } else {
                                                    ...
                                                    <div key={prob.id} className="py-0.5 border-b border-gray-100 last:border-b-0">
                                                        <div className="flex items-start justify-between gap-1">
                                                            <div className="flex-1 min-w-0 flex items-center gap-1.5">
                                                                ...
                                                                <span
                                                                    className={`inline-block text-[9px] px-1 py-0.5 rounded-full font-medium flex-shrink-0 ${
                                                                        prob.status === 'active'
