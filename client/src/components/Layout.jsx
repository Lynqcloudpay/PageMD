...
const Layout = ({ children }) => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#F0F2F5] transition-colors">
            ...
            <div className="flex flex-1">
                ...
                <aside
                    className={cn(
                        ...
                        sidebarCollapsed ? 'w-[3.5rem]' : 'w-[14rem]'
                    )}
                >
                                ...
                                <>
                                    <Link to="/dashboard" className="flex items-center group">
                                        <img
                                            src="/logo.png"
                                            alt="PageMD Logo"
                                            className="h-6 w-auto object-contain max-w-[100px] opacity-85 group-hover:opacity-100 transition-opacity"
                        ...
                        {!sidebarCollapsed && (
                            <div className="px-2.5 pt-3 pb-1">
                                <button
                                    ...
                                    className="w-full flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-gray-100 text-gray-400 text-[11px] hover:bg-gray-200/70 hover:text-gray-500 transition-colors"
                                >
                                ...
                                <div className="flex items-center gap-1.5">
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            sidebarCollapsed ? "justify-center" : "hover:bg-gray-100/70"
                                        )}
                                    >
                                        ...
                                        {!sidebarCollapsed && (
                                            <div className="text-left flex-1 min-w-0">
                                                <div className="text-[11px] font-semibold text-gray-800 leading-tight truncate">{user.firstName} {user.lastName}</div>
                                                <div className="text-[9px] text-gray-400 font-medium truncate">{user.role_name || user.role || 'User'}</div>
                                            </div>
                                        )}
                                    </button>
                                    {!sidebarCollapsed && (
                ...
                <main
                    className={cn(
                        ...
                        sidebarCollapsed ? "ml-[3.5rem]" : "ml-[14rem]"
                    )}
                >
                    {/* Header strip */}
                    ...
                    {/* Page Content */}
                    <div className="flex-1 overflow-y-auto min-h-0 relative h-full bg-[#F0F2F5]">
