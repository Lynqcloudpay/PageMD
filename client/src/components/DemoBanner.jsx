...
const DemoBanner = () => {
    return (
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 bg-[length:200%_auto] animate-gradient-x text-white py-2 px-4 relative z-[9999] shadow-lg">
            <div className="max-w-7xl mx-auto flex items-center justify-center gap-3 text-xs md:text-sm font-bold tracking-tight text-center">
                <div className="flex items-center gap-2 px-2 py-0.5 bg-white/20 rounded-full border border-white/30 backdrop-blur-md shrink-0">
                    <Zap className="w-3 h-3 fill-current" />
                    <span>DEMO MODE</span>
                </div>
                <div className="flex flex-col md:flex-row md:items-center gap-x-2 gap-y-1">
                    <span className="opacity-90 uppercase">Not for clinical use. Actions are simulated.</span>
                    ...
                    <div className="flex items-center gap-1.5 text-blue-100 italic">
                        ...
                        <span>External integrations (Rx, Labs, Fax, Email) are simulated.</span>
                    </div>
                </div>
            </div>
