            ...
            {step === 'config' ? (
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-xs font-bold text-gray-500 uppercase mb-2 ml-1">Recipient Email</label>
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all"
                                />
                            </div>
                        ...
                        <div className="border-t border-gray-100 pt-4">
                            <button
                                ...
                                className="flex items-center gap-2 text-xs font-bold text-gray-500 hover:text-blue-600 transition-colors uppercase tracking-wider"
                            >
                            ...
                            {showPreview && (
                                <div className="mt-4 p-6 border border-gray-200 rounded-2xl bg-white shadow-sm overflow-hidden animate-in fade-in slide-in-from-top-2 duration-300">
                                    <div className="flex items-center gap-3 mb-6 border-b border-gray-100 pb-4">
                                        <div className="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center text-white">
                                            <span className="font-bold text-lg">PM</span>
                                        </div>
                                        <div>
                                            <h5 className="text-sm font-bold text-gray-900">PageMD</h5>
                                            <p className="text-[10px] text-gray-500">support@pagemdemr.com</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="pt-4 border-t border-slate-50 text-[10px] text-gray-400 text-center">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-3 pt-2">
                        ...
                        <div className="flex gap-2">
                            <div className="flex-1 p-3 bg-gray-50 rounded-lg text-xs font-mono text-gray-600 truncate border border-gray-200">
                    ...
                    <div className="flex gap-3 pt-4">
                        <button
                            onClick={onClose}
                            className="flex-1 px-4 py-3 bg-gray-50 text-white rounded-xl font-bold hover:bg-gray-100 transition-all shadow-lg"
                        >
                            Done
                        </button>
                        <a
                            ...
                            className="px-4 py-3 bg-white border border-gray-200 text-gray-700 rounded-xl font-bold hover:bg-gray-50 transition-all flex items-center gap-2"
                        >
