...
import { Pill, Stethoscope, Upload, Send, Search, X, ShoppingCart, Trash2, Plus, Check } from 'lucide-react';
...
export const OrderModal = ({ isOpen, onClose, onSuccess, initialTab = 'labs', diagnoses = [] }) => {
    ...
    // Med specific state (for currently adding med)
                    ...
                    {['Labs', 'Imaging', 'Procedures', 'Referrals', 'Medications'].map(tab => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-6 py-3 text-sm font-medium transition-colors border-r border-gray-200 last:border-r-0 ${activeTab === id
