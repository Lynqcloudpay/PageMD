                ...
                <div className="bg-white/80 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl shadow-slate-200/50 p-8 md:p-10 relative z-10 transition-all duration-500">
                    ...
                    {submitted ? (
                        <div className="bg-blue-50/50 border border-blue-100 rounded-2xl p-8 text-center animate-in fade-in zoom-in duration-300">
                            ...
                            <Link
                                to="/portal/login"
                                className="inline-flex items-center justify-center gap-2 w-full bg-white border border-gray-200 hover:border-blue-300 hover:bg-gray-50 text-gray-700 font-semibold py-3 px-4 rounded-xl transition-all duration-200 shadow-sm"
                            >
                                <ArrowLeft size={16} />
                                Back to Login
                            </Link>
                            ...
                            <div>
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium"
