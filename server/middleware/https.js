...
const securityHeaders = (req, res, next) => {
  ...
  res.setHeader(
    'Content-Security-Policy',
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: blob: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://pagemdemr.com https://bemypcp.com https://rxnav.nlm.nih.gov http://localhost:3000 http://localhost:5173 blob:;"
  );
